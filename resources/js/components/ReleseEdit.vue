 ...
 <!-- fieldsets  1st part-->
                            <fieldset>
                                ...
                                <div class="card mb-4" v-if="is_various_artist == 0">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <select id="MultipleOtherKeyArtist" v-model="other_key_artist_list" class="form-control"  multiple>
                                ...
                                <div class="card mb-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input Called_tooltips" type="radio" v-model="upcShowHide" id="inlineRadio2" value="1" :checked="upc_ean_jan != null ">
                                                    <label class="form-check-label" for="inlineRadio2">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" v-model="upcShowHide" :checked="upc_ean_jan == null " id="inlineRadio3" value="0">
                            ...
                            <fieldset>
                                <div class="row card" v-for="(track, index) in tracks" :key="index">
                                    ...
                                    <div class="collapse row px-3" :id="'collapseExample'+index">
                                        ...
                                        <div class="col-12">
                                            <select v-model="track.other_key_artist_list_track" class="form-control" multiple style="height: 100px !important;">
                                                <option v-for='(item, index) in otherkeyartist' :key="index" :value='item.id'>{{ item.other_key_artist_name }}</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12 collapse" :id="'collapseAdvance'+index">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <label class="control-label">Label name <span class="text-danger">*</span></label>
                                                    <select v-model="track.track_label_id"  name="track_label_id" id="" class="custom-select form-control">
                                                        <option v-for='(item, index) in labels' :key="index" :value='item.id'>{{ item.official_name }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="col-12 my-2 text-right">
                                        <button v-if="track.id" type="button" class="btn btn-sm btn-info" v-on:click="UpdateTracks(track)">Update Track</button>
                                        <button v-else type="button" class="btn btn-sm btn-success" v-on:click="AddNewTracks(index)">Add New Track</button>
                                    </div>
                                </div>
                                <div class="row my-2">
                                    <div class="col-12 text-right">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card" v-for="(pub, ind) in Publishing" :key="ind">
                                            <div class="row">
                                                <div class="col-12 text-right">
                                                    <a href="#" class="text-danger" v-on:click="removePublishing(ind)"> <b> <i class="ti-close font-weight-bold"></i></b></a>
                                                </div>
                                                <div class="col-md-4">
...
export default {
    props:['artists','labels','stores','users', 'alllanguage', 'genre1', 'alldetails', 'otherkeyartist','roles'],
    data() {
        return {
            userId:'',
    ...
    methods: {
        AddNewPUBLISHING(index){
            ...
            () => {
                ...
                axios.post('/admin/asset/add/publishing',formData,{
                headers: { 'Content-Type': 'multipart/form-data'}, } )
                .then((res)=>{
                Report.success('Add New Publishing','Added sucessfully','Okay');
                window.location.href = '/admin/asset/'+this.alldetails.id+'/edit'
                },()=>{
                    Notify.failure();
                })
            },
        ...
        UpdatePUBLISHING(Publishing){
            ...
            () => {
                ...
                axios.post('/admin/asset/update/publishing',formData,{
                headers: { 'Content-Type': 'multipart/form-data'}, } )
                .then((res)=>{
        ...
        AddNewTracks(index){
            ...
            () => {
                ...
                axios.post('/admin/asset/add/track',formData,{
                headers: { 'Content-Type': 'multipart/form-data'}, } )
                .then((res)=>{
        ...
        UpdateTracks(tracks){
            ...
            () => {
                ...
                axios.post('/admin/asset/update/track',formData,{
                headers: { 'Content-Type': 'multipart/form-data'}, } )
                .then((res)=>{
        ...
        removeE(index){
            ...
            () => {
                ...
                axios.post('/admin/asset/delete/track',formData,{
                headers: { 'Content-Type': 'multipart/form-data'}, } )
                .then((res)=>{
        ...
        removePublishing(index){
            ...
            () => {
                ...
                axios.post('/admin/asset/delete/publishing',formData,{
                headers: { 'Content-Type': 'multipart/form-data'}, } )
                .then((res)=>{
