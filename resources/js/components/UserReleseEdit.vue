                        ...
                        <div class="col-md-12 mx-0">
                            ...
                            <form id="msform">
                                ...
                                <fieldset>
                                    ...
                                    <button type="button" name="previous" class="previous btn btn-secondary mx-2" > Previous </button>
                                    <button v-show="ShowConfirmBtn" type="button" name="next" class="btn btn-success" v-on:click="SubmitReleseDetails()"> Confirm</button>
                                </fieldset>
                            </form>
                        </div>
                    </div>
...
export default {
    props:['artists','labels','stores','alllanguage', 'genre1', 'alldetails'],
    data() {
        return {
            ShowConfirmBtn:true,
            HiddenAssetId:'',
    ...
    methods: {
        ...
        SubmitReleseDetails(){
            ...
            () => {
                if( this.language  && this.release_title &&  this.is_various_artist &&  this.genre_one && this.p_copy && this.c_copy && this.previously_release && this.label_id && this.contritibutor_track_artist_name  &&  this.contritibutor_role  &&  this.contritibutor_share  && this.contritibutor_publishing  
