...
<div class="row">
    <div class="col-md-12 mb-3 bg-white">
        <div class="ml-4">
            <h3 style="font-size: 400">Edit news </h3>
            @if (Session::has('msg'))
            ...
            <form action="{{route('news.store')}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-8 mb-2">
                        ...
                        <input type="text" name="news_heading" class="form-control" value="{{@$news->news_heading}}">
                    ...
                    <div class="col-12 mb-2">
                        ...
                        <textarea id="short_description" type="text" rows="3" name="short_description" class="form-control h-auto">{{@$news->short_description}} </textarea>
                        <span class="text-danger">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <textarea id="editor" type="text" rows="8" name="long_description" class="form-control h-auto">{{@$news->long_description}}</textarea>
                        <span class="text-danger">
