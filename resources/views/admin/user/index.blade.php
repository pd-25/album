...
@section('title', env('APP_NAME').' | Users-index'  )
@section('content')
<div class="row">
    <div class="col-md-12 mb-3 bg-white">
        <div class="ml-4">
            <h3 style="font-size: 400"> All users </h3>
            @if (Session::has('msg'))
                                ...
                                @foreach ($artists as $artist)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('users.edit', encrypt($artist->id)) }}"><i
                                                    class="ti-pencil btn btn-sm btn-primary"></i></a>
                                            <form method="POST"
                                                action="{{ route('users.destroy', encrypt($artist->id)) }}"
                                                class="action-icon">
                                                @csrf
