...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form class="myform" action="{{ route('asset.update', @$allDetails->id) }}" method="POST" id="yourFormId" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <section>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input readonly required type="text" name="internal_release_id" class="form-control"
