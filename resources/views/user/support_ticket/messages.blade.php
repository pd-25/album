...
<div class="container">
    <div class="card mb-1 shadow rounded" style="height: 400px; overflow:auto">
        <div class="row">
            <div class="col-12 mb-3 d-flex justify-content-between">
                ...
                <a href="{{route('support.index')}}" class="btn btn-link">Back</a>
            </div>
    ...
    @if (@$supportic->status == 1)
        <div class="card shadow rounded">
            <form action="{{route('support.sendmessage')}}" method="post">
            @csrf
            @method('POST')
            <div class="row">
                <div class="col-10">
...
@section('script')
    <script>
    ClassicEditor
        .create( document.querySelector( '#editorSupportTicket' ) )
        .catch( error => {
            console.error( error );
        } )
    </script>
